...
<div>
    <div class="flex flex-row shadow-lg m-4 transition-all duration-300 bg-white rounded-lg">
        ...
        <div class="w-full p-4 bg-gray-100">
            ...
            <h1><b>Date de la demande</b>: {{$request['created_at']->format('d-m-Y')}}</h1>
            ...
            @endif
            <h1>Nombre d'items: {{$request->items->count()}}</h1>
        </div>

        <div class="flex flex-col w-full border-s-2 border-dashed border-l-rose-600 p-4  ltr bg-gray-100">
            <div class="">
