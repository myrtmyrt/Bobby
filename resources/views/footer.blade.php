...
<footer class="flex-shrink-0 w-full bg-gray-500">
    <div class="w-3/4 m-auto flex justify-center items-start p-12 text-white  ">
        <div class="w-1/2 pt-1 mb-5  ">
            ...
            <ul class="pt-4 mb-3">
                <li><img src="{{ asset('assets/Lieu.png') }}" width=20px alt="Lieu-icon" class="inline mr-2 ">Salle BF E101</li>
                <li><img src="{{ asset('assets/Mail.png') }}" width=20px alt="Mail-icon" class="inline mr-2 ">bde@assos.utc.fr</li>
                <li><img src="{{ asset('assets/Facebook.png') }}" width=10px alt="Facebook-icon" class="inline mr-4 ">Roger Delacom</li>
                <li><img src={Instagram} width=20px alt="Instagram-icon" class="inline mr-2 ">bde_utc</li>
            </ul>
            <button class='hover:shadow-primary  hover:shadow font-medium transition-shadow w-1/2 text-white py-2 px-4 bg-primary mt-3  rounded'>
                Contacter le BDE
            </button>
        </div>
